...
async function runScriptTask(config) {
  ...
  try {
    ...
    fn = require("vm").runInNewContext(wrapped, { module: { exports: {} }, console: console, require: require, store: require("./store"), mysql: require("./mysql"), fetch: global.fetch, Date: Date, JSON: JSON, Promise: Promise, Math: Math, setTimeout: setTimeout, clearTimeout: clearTimeout }, { timeout: 60000 });
