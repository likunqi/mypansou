...
const PROMPT_DEFS = {
  ...
  desc: {
    label: "资源简介生成（AI 兜底描述）",
    desc: "资源无描述且豆瓣未命中时，AI 根据标题生成一句话简介",
    default: "你是网盘资源库的内容简介助手。根据资源标题生成一句简洁的中文简介（30-80 字），概括资源的内容类型与看点（如剧集题材/风格/适合人群），不要编造具体情节、演员、评分等未提供的信息，不要输出标题前缀或引号。",
  },
};
